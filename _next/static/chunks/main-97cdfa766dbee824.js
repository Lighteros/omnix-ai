  ...
  [179],
  {
              ...
              (a.isFallback ||
                (a.nextExport &&
                  ((0, j.isDynamicRoute)(n.pathname) ||
                    location.search ||
                    $)) ||
                (a.props && a.props.__N_SSG && (location.search || $))) &&
              n
                .replace(
                  n.pathname +
                    "?" +
      ...
      class V {
        ...
        async change(e, t, r, n, a) {
          ...
          this._inFlightRoute &&
            this.clc &&
            (X ||
              V.events.emit("routeChangeError", T(), this._inFlightRoute, J),
            this.clc(),
            (this.clc = null)),
            (r = (0, w.addBasePath)(
              (0, b.addLocale)(
          ...
          try {
            ...
            let v =
              F && !y && !G && !Z && (0, R.compareRouterStates)(_, this.state);
            if (!v) {
              try {
                await this.set(_, o, y);
              } catch (e) {
        ...
        async getRouteInfo(e) {
          ...
          try {
            ...
            return (
              R.__N_SSP && E.dataHref && A && delete this.sdc[A],
              this.isPreview ||
                !R.__N_SSG ||
                p ||
                W(
    ...
    37762: function (e, t, r) {
      ...
      function s(e) {
        let t,
          r,
          { segment: n, routeKeys: a, keyPrefix: o } = e,
          l =
            ((t = 97),
            (r = 1),
            () => {
