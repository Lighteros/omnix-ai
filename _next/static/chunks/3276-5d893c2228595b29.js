  ...
  [3276],
  {
    ...
    68872: function (e, t, r) {
          ...
          ref: (0, i.useCallback)(
            (e) => {
              t &&
                ...
                e && (C && (e.src = e.src), e.complete && g(e, d, b, y, _, h));
            },
            [r, d, b, y, _, C, h, t]
          ),
          onLoad: (e) => {
      ...
      let b = (0, i.forwardRef)((e, t) => {
        ...
        let [b, y] = (0, i.useState)(!1),
          [_, w] = (0, i.useState)(!1),
          { props: O, meta: C } = (0, a.getImgProps)(e, {
        ...
        return i.default.createElement(
          ...
          C.priority
            ? i.default.createElement(v, { isAppRouter: !r, imgAttributes: O })
            : null
        );
      });
      ("function" == typeof t.default ||
    ...
    95569: function (e, t, r) {
      ...
      let y = o.default.forwardRef(function (e, t) {
          ...
          let M = o.default.useContext(c.RouterContext),
            ...
            A = !M,
            T = !1 !== _,
            N = null === _ ? m.PrefetchKind.AUTO : m.PrefetchKind.FULL,
            { href: L, as: F } = o.default.useMemo(() => {
              if (!M) {
                let e = b(u);
                return { href: e, as: h ? b(h) : e };
              }
              let [e, t] = (0, i.resolveHref)(M, u, !0);
              return { href: e, as: h ? (0, i.resolveHref)(M, h) : t || e };
            }, [M, u, h]),
            U = o.default.useRef(L),
            D = o.default.useRef(F);
          R && (n = o.default.Children.only(r));
          let W = R ? n && "object" == typeof n && n.ref : t,
            [B, H, K] = (0, d.useIntersection)({ rootMargin: "200px" }),
            V = o.default.useCallback(
              (e) => {
                (D.current !== F || U.current !== L) &&
                  (K(), (D.current = F), (U.current = L)),
                  B(e),
                  W &&
                    ("function" == typeof W
                      ? W(e)
          ...
          o.default.useEffect(() => {
            z && H && T && v(z, L, F, { locale: P }, { kind: N }, A);
          }, [F, L, H, P, T, null == M ? void 0 : M.locale, z, A, N]);
          let G = {
            ref: V,
            onClick(e) {
          ...
          if ((0, a.isAbsoluteUrl)(F)) G.href = F;
          else if (!R || w || ("a" === n.type && !("href" in n.props))) {
            let e = void 0 !== P ? P : null == M ? void 0 : M.locale,
              t =
          ...
          return R
            ...
            : o.default.createElement("a", { ...I, ...G }, r);
        }),
        _ = y;
      ("function" == typeof t.default ||
        ("object" == typeof t.default && null !== t.default)) &&
    ...
    55471: function (e, t, r) {
      ...
      function u(e, t) {
        ...
        let u,
          ...
          { imgConf: k, showAltText: z, blurComplete: A, defaultLoader: T } = t,
          N = k || o.imageConfigDefault;
        if ("allSizes" in N) u = N;
        else {
          let e = [...N.deviceSizes, ...N.imageSizes].sort((e, t) => e - t),
            t = N.deviceSizes.sort((e, t) => e - t);
          u = { ...N, allSizes: e, deviceSizes: t };
        }
        let L = M.loader || T;
        ...
        (!(c = "string" == typeof c ? c : U) ||
          ...
          ((d = !0), (B = !1)),
          u.unoptimized && (d = !0),
          F && c.endsWith(".svg") && !u.dangerouslyAllowSVG && (d = !0),
          p && (P = "high");
        let H = l(h),
          K = Object.assign(
            y
          ...
          G = (function (e) {
            ...
            return {
              ...
              srcSet: a
                ...
                .join(", "),
              src: u({ config: t, src: r, quality: i, width: a[c] }),
            };
          })({
            config: u,
            src: c,
          ...
          Y = { unoptimized: d, priority: p, placeholder: C, fill: y };
