...
\f\r"'\`<>=]|("|')|))|$)`,
      ...
      let eB =
          (e, t = "end") =>
          (r) => {
            r = "end" === t ? Math.min(r, 0.999) : Math.max(r, 0.001);
            let i = r * e,
            ...
            return (
              ...
              (o) => {
                ...
                let n = ez(0, 1, eD(t[a], t[a + 1], o)),
                  s = ((l = a), eW(r) ? r[eU(0, r.length, l)] : r);
                return (n = s(n)), ej(e[a], e[a + 1], n);
              }
            );
          ...
          (this.tick = (t) => {
            ...
            u
              ? ((this.playState = "finished"),
                null === (r = this.resolve) || void 0 === r || r.call(this, p))
              : "idle" !== this.playState &&
      ...
      var t$ = r(92592),
        ...
        tE = (e, t, r) =>
          t in e
            ...
            : (e[t] = r),
        tk = (e, t) => {
          for (var r in t || (t = {})) t_.call(t, r) && tE(e, r, t[r]);
          if (tA) for (var r of tA(t)) tO.call(t, r) && tE(e, r, t[r]);
          return e;
        };
      function tI() {
        return {
      ...
      let tT = {
        ...
        tP = c`button{border-radius:var(--wcm-secondary-button-border-radius);height:28px;padding:0 10px;background-color:var(--wcm-accent-color)}button path{fill:var(--wcm-accent-fill-color)}button::after{border-radius:inherit;border:1px solid var(--wcm-color-overlay)}button:disabled::after{background-color:transparent}.wcm-icon-left svg{margin-right:5px}.wcm-icon-right svg{margin-left:5px}button:active::after{background-color:var(--wcm-color-overlay)}.wcm-ghost,.wcm-ghost:active::after,.wcm-outline{background-color:transparent}.wcm-ghost:active{opacity:.5}@media(hover:hover){button:hover::after{background-color:var(--wcm-color-overlay)}.wcm-ghost:hover::after{background-color:transparent}.wcm-ghost:hover{opacity:.5}}button:disabled{background-color:var(--wcm-color-bg-3);pointer-events:none}.wcm-ghost::after{border-color:transparent}.wcm-ghost path{fill:var(--wcm-color-fg-2)}.wcm-outline path{fill:var(--wcm-accent-color)}.wcm-outline:disabled{background-color:transparent;opacity:.5}`;
      var tM = Object.defineProperty,
        tS = Object.getOwnPropertyDescriptor,
        tR = (e, t, r, i) => {
          for (
            var o, l = i > 1 ? void 0 : i ? tS(t, r) : t, a = e.length - 1;
            a >= 0;
            a--
          )
            (o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
          return i && l && tM(t, r, l), l;
        };
      let tL = class extends es {
        constructor() {
          super(...arguments),
            (this.disabled = !1),
      ...
      (tL.styles = [tT.globalCss, tP]),
        tR([ep({ type: Boolean })], tL.prototype, "disabled", 2),
        tR([ep()], tL.prototype, "iconLeft", 2),
        tR([ep()], tL.prototype, "iconRight", 2),
        tR([ep()], tL.prototype, "onClick", 2),
        tR([ep()], tL.prototype, "variant", 2),
        (tL = tR([ed("wcm-button")], tL));
      let tW = c`:host{display:inline-block}button{padding:0 15px 1px;height:40px;border-radius:var(--wcm-button-border-radius);color:var(--wcm-accent-fill-color);background-color:var(--wcm-accent-color)}button::after{content:'';top:0;bottom:0;left:0;right:0;position:absolute;background-color:transparent;border-radius:inherit;transition:background-color .2s ease;border:1px solid var(--wcm-color-overlay)}button:active::after{background-color:var(--wcm-color-overlay)}button:disabled{padding-bottom:0;background-color:var(--wcm-color-bg-3);color:var(--wcm-color-fg-3)}.wcm-secondary{color:var(--wcm-accent-color);background-color:transparent}.wcm-secondary::after{display:none}@media(hover:hover){button:hover::after{background-color:var(--wcm-color-overlay)}}`;
      var tj = Object.defineProperty,
        tD = Object.getOwnPropertyDescriptor,
        tN = (e, t, r, i) => {
          for (
            var o, l = i > 1 ? void 0 : i ? tD(t, r) : t, a = e.length - 1;
            a >= 0;
            a--
          )
            (o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
          return i && l && tj(t, r, l), l;
        };
      ...
      (tU.styles = [tT.globalCss, tW]),
        tN([ep({ type: Boolean })], tU.prototype, "disabled", 2),
        tN([ep()], tU.prototype, "variant", 2),
        (tU = tN([ed("wcm-button-big")], tU));
      let tz = c`:host{background-color:var(--wcm-color-bg-2);border-top:1px solid var(--wcm-color-bg-3)}div{padding:10px 20px;display:inherit;flex-direction:inherit;align-items:inherit;width:inherit;justify-content:inherit}`;
      var tH = Object.defineProperty,
        tZ = Object.getOwnPropertyDescriptor;
      let tB = class extends es {
        render() {
          return H`<div><slot></slot></div>`;
        }
      };
      (tB.styles = [tT.globalCss, tz]),
        (tB = ((e, t, r, i) => {
          for (
            var o, l = i > 1 ? void 0 : i ? tZ(t, r) : t, a = e.length - 1;
            a >= 0;
            a--
          )
            (o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
          return i && l && tH(t, r, l), l;
        })([ed("wcm-info-footer")], tB));
      let tV = {
        ...
        tq = c`.wcm-toolbar-placeholder{top:0;bottom:0;left:0;right:0;width:100%;position:absolute;display:block;pointer-events:none;height:100px;border-radius:calc(var(--wcm-background-border-radius) * .9);background-color:var(--wcm-background-color);background-position:center;background-size:cover}.wcm-toolbar{height:38px;display:flex;position:relative;margin:5px 15px 5px 5px;justify-content:space-between;align-items:center}.wcm-toolbar img,.wcm-toolbar svg{height:28px;object-position:left center;object-fit:contain}#wcm-wc-logo path{fill:var(--wcm-accent-fill-color)}button{width:28px;height:28px;border-radius:var(--wcm-icon-button-border-radius);border:0;display:flex;justify-content:center;align-items:center;cursor:pointer;background-color:var(--wcm-color-bg-1);box-shadow:0 0 0 1px var(--wcm-color-overlay)}button:active{background-color:var(--wcm-color-bg-2)}button svg{display:block;object-position:center}button path{fill:var(--wcm-color-fg-1)}.wcm-toolbar div{display:flex}@media(hover:hover){button:hover{background-color:var(--wcm-color-bg-2)}}`;
      var tF = Object.defineProperty,
        tK = Object.getOwnPropertyDescriptor;
      let tQ = class extends es {
        render() {
          return H`<div class="wcm-toolbar-placeholder"></div><div class="wcm-toolbar">${tV.WALLET_CONNECT_LOGO} <button @click="${eC.jb.close}">${tV.CROSS_ICON}</button></div>`;
        }
      };
      (tQ.styles = [tT.globalCss, tq]),
        (tQ = ((e, t, r, i) => {
          for (
            var o, l = i > 1 ? void 0 : i ? tK(t, r) : t, a = e.length - 1;
            a >= 0;
            a--
          )
            (o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
          return i && l && tF(t, r, l), l;
        })([ed("wcm-modal-backcard")], tQ));
      let tY = c`main{padding:20px;padding-top:0;width:100%}`;
      var tG = Object.defineProperty,
        tX = Object.getOwnPropertyDescriptor;
      let tJ = class extends es {
        render() {
          return H`<main><slot></slot></main>`;
        }
      };
      (tJ.styles = [tT.globalCss, tY]),
        (tJ = ((e, t, r, i) => {
          for (
            var o, l = i > 1 ? void 0 : i ? tX(t, r) : t, a = e.length - 1;
            a >= 0;
            a--
          )
            (o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
          return i && l && tG(t, r, l), l;
        })([ed("wcm-modal-content")], tJ));
      let t0 = c`footer{padding:10px;display:flex;flex-direction:column;align-items:inherit;justify-content:inherit;border-top:1px solid var(--wcm-color-bg-2)}`;
      var t1 = Object.defineProperty,
        t2 = Object.getOwnPropertyDescriptor;
      let t5 = class extends es {
        render() {
          return H`<footer><slot></slot></footer>`;
        }
      };
      (t5.styles = [tT.globalCss, t0]),
        (t5 = ((e, t, r, i) => {
          for (
            var o, l = i > 1 ? void 0 : i ? t2(t, r) : t, a = e.length - 1;
            a >= 0;
            a--
          )
            (o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
          return i && l && t1(t, r, l), l;
        })([ed("wcm-modal-footer")], t5));
      ...
      var t4 = Object.defineProperty,
        ...
        t6 = (e, t, r, i) => {
          for (
            var o, l = i > 1 ? void 0 : i ? t7(t, r) : t, a = e.length - 1;
            a >= 0;
            a--
          )
            (o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
      ...
      let t8 = class extends es {
        ...
        backBtnTemplate() {
          return H`<button class="wcm-back-btn" @click="${eC.AV.goBack}">${tV.BACK_ICON}</button>`;
        }
        actionBtnTemplate() {
      ...
      (t8.styles = [tT.globalCss, t3]),
        t6([ep()], t8.prototype, "title", 2),
        t6([ep()], t8.prototype, "onAction", 2),
        t6([ep()], t8.prototype, "actionIcon", 2),
        t6([ep({ type: Boolean })], t8.prototype, "border", 2),
        (t8 = t6([ed("wcm-modal-header")], t8));
      let t9 = {
          ...
          isMobileAnimation: () => window.innerWidth <= t9.MOBILE_BREAKPOINT,
          async preloadImage(e) {
            ...
            return Promise.race([t, eC.zv.wait(3e3)]);
          },
          getErrorMessage: (e) =>
          ...
          getRecentWallet() {
            try {
              let e = localStorage.getItem(t9.WCM_RECENT_WALLET_DATA);
          ...
          openWalletExplorerUrl() {
            eC.zv.openHref(t9.EXPLORER_WALLET_URL, "_blank");
          },
          getCachedRouterWalletPlatforms() {
            let { desktop: e, mobile: t } = eC.zv.getWalletRouterData(),
              r = !!e?.native,
              i = !!e?.universal,
              o = !!t?.native || !!t?.universal;
            ...
            let t = eC.zv.isMobile(),
              {
                ...
                isWeb: i,
                isMobile: o,
              } = t9.getCachedRouterWalletPlatforms();
            t
              ? o
        ...
        re = c`.wcm-router{overflow:hidden;will-change:transform}.wcm-content{display:flex;flex-direction:column}`;
      var rt = Object.defineProperty,
        rr = Object.getOwnPropertyDescriptor,
        ri = (e, t, r, i) => {
          for (
            var o, l = i > 1 ? void 0 : i ? rr(t, r) : t, a = e.length - 1;
            a >= 0;
            a--
          )
            (o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
          return i && l && rt(t, r, l), l;
        };
      let ro = class extends es {
        constructor() {
          super(),
        ...
        get routerEl() {
          return t9.getShadowRootElement(this, ".wcm-router");
        }
        get contentEl() {
          return t9.getShadowRootElement(this, ".wcm-content");
        }
        viewTemplate() {
          switch (this.view) {
            case "ConnectWallet":
      ...
      (ro.styles = [tT.globalCss, re]),
        ri([eu()], ro.prototype, "view", 2),
        ri([eu()], ro.prototype, "prevView", 2),
        (ro = ri([ed("wcm-modal-router")], ro));
      let rl = c`div{height:36px;width:max-content;display:flex;justify-content:center;align-items:center;padding:9px 15px 11px;position:absolute;top:12px;box-shadow:0 6px 14px -6px rgba(10,16,31,.3),0 10px 32px -4px rgba(10,16,31,.15);z-index:2;left:50%;transform:translateX(-50%);pointer-events:none;backdrop-filter:blur(20px) saturate(1.8);-webkit-backdrop-filter:blur(20px) saturate(1.8);border-radius:var(--wcm-notification-border-radius);border:1px solid var(--wcm-color-overlay);background-color:var(--wcm-color-overlay)}svg{margin-right:5px}@-moz-document url-prefix(){div{background-color:var(--wcm-color-bg-3)}}.wcm-success path{fill:var(--wcm-accent-color)}.wcm-error path{fill:var(--wcm-error-color)}`;
      var ra = Object.defineProperty,
        rn = Object.getOwnPropertyDescriptor,
        rs = (e, t, r, i) => {
          for (
            var o, l = i > 1 ? void 0 : i ? rn(t, r) : t, a = e.length - 1;
            a >= 0;
            a--
          )
            (o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
        ...
        render() {
          ...
          return this.open
            ? H`<div class="${eg({
                ...
                "wcm-error": "error" === t,
              })}">${"success" === t ? tV.CHECKMARK_ICON : null} ${
                "error" === t ? tV.CROSS_ICON : null
      ...
      (rc.styles = [tT.globalCss, rl]),
        rs([eu()], rc.prototype, "open", 2),
        (rc = rs([ed("wcm-modal-toast")], rc));
      let rh = {
          generate(e, t, r) {
            let i = "#141414",
              o = [],
              l = (function (e, t) {
                let r = Array.prototype.slice.call(
                    t$.create(e, { errorCorrectionLevel: "Q" }).modules.data,
                    0
                  ),
            ...
            return (
              ...
              Object.entries(m)
                .map(([e, t]) => {
                  let r = t.filter((e) => t.every((t) => !rd(e, t, a)));
                  return [Number(e), r];
                })
                .forEach(([e, t]) => {
                  t.forEach((t) => {
              ...
              Object.entries(m)
                ...
                .map(([e, t]) => {
                  let r = t.filter((e) => t.some((t) => rd(e, t, a)));
                  return [Number(e), r];
                })
                .map(([e, t]) => {
                  t.sort((e, t) => (e < t ? -1 : 1));
                  let r = [];
                  for (let e of t) {
                    let t = r.find((t) => t.some((t) => rd(e, t, a)));
                    t ? t.push(e) : r.push([e]);
                  }
        ...
        svgTemplate() {
          let e =
            "light" === eC.ThemeCtrl.state.themeMode
              ? this.size
              : this.size - 36;
          return Z`<svg height="${e}" width="${e}">${rh.generate(
            this.uri,
            e,
            e / 4
          )}</svg>`;
        ...
        render() {
          ...
          return H`<div style="${`width: ${this.size}px`}" class="${eg(e)}">${
            this.walletId || this.imageUrl
              ? H`<wcm-wallet-image walletId="${tx(
                  this.walletId
                )}" imageId="${tx(this.imageId)}" imageUrl="${tx(
                  this.imageUrl
                )}"></wcm-wallet-image>`
              : tV.WALLET_CONNECT_ICON_COLORED
          } ${this.svgTemplate()}</div>`;
        }
      };
      (rg.styles = [tT.globalCss, rm]),
        rw([ep()], rg.prototype, "uri", 2),
        rw([ep({ type: Number })], rg.prototype, "size", 2),
        rw([ep()], rg.prototype, "imageId", 2),
        rw([ep()], rg.prototype, "walletId", 2),
        rw([ep()], rg.prototype, "imageUrl", 2),
        (rg = rw([ed("wcm-qrcode")], rg));
      ...
      var rf = Object.defineProperty,
        ...
        ry = (e, t, r, i) => {
          for (
            var o, l = i > 1 ? void 0 : i ? rb(t, r) : t, a = e.length - 1;
            a >= 0;
            a--
          )
            (o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
          return i && l && rf(t, r, l), l;
        };
      let rx = class extends es {
        ...
        render() {
          return H`<input type="text" @input="${this.onChange}" placeholder="Search wallets"> ${tV.SEARCH_ICON}`;
        }
      };
      (rx.styles = [tT.globalCss, rv]),
        ry([ep()], rx.prototype, "onChange", 2),
        (rx = ry([ed("wcm-search-input")], rx));
      let r$ = c`@keyframes rotate{100%{transform:rotate(360deg)}}@keyframes dash{0%{stroke-dasharray:1,150;stroke-dashoffset:0}50%{stroke-dasharray:90,150;stroke-dashoffset:-35}100%{stroke-dasharray:90,150;stroke-dashoffset:-124}}svg{animation:rotate 2s linear infinite;display:flex;justify-content:center;align-items:center}svg circle{stroke-linecap:round;animation:dash 1.5s ease infinite;stroke:var(--wcm-accent-color)}`;
      var rC = Object.defineProperty,
        rA = Object.getOwnPropertyDescriptor;
      let r_ = class extends es {
        render() {
          return H`<svg viewBox="0 0 50 50" width="24" height="24"><circle cx="25" cy="25" r="20" fill="none" stroke-width="4" stroke="#fff"/></svg>`;
        }
      };
      (r_.styles = [tT.globalCss, r$]),
        (r_ = ((e, t, r, i) => {
          for (
      ...
      var rE = Object.defineProperty,
        ...
        rI = (e, t, r, i) => {
          for (
            var o, l = i > 1 ? void 0 : i ? rk(t, r) : t, a = e.length - 1;
            a >= 0;
            a--
          )
            (o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
      ...
      (rT.styles = [tT.globalCss, rO]),
        rI([ep()], rT.prototype, "variant", 2),
        rI([ep()], rT.prototype, "color", 2),
        (rT = rI([ed("wcm-text")], rT));
      let rP = c`button{width:100%;height:100%;border-radius:var(--wcm-button-hover-highlight-border-radius);display:flex;align-items:flex-start}button:active{background-color:var(--wcm-color-overlay)}@media(hover:hover){button:hover{background-color:var(--wcm-color-overlay)}}button>div{width:80px;padding:5px 0;display:flex;flex-direction:column;align-items:center}wcm-text{width:100%;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;text-align:center}wcm-wallet-image{height:60px;width:60px;transition:all .2s ease;border-radius:var(--wcm-wallet-icon-border-radius);margin-bottom:5px}.wcm-sublabel{margin-top:2px}`;
      var rM = Object.defineProperty,
        rS = Object.getOwnPropertyDescriptor,
        rR = (e, t, r, i) => {
          for (
            var o, l = i > 1 ? void 0 : i ? rS(t, r) : t, a = e.length - 1;
            a >= 0;
            a--
          )
            (o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
      ...
      let rL = class extends es {
        ...
        render() {
          ...
          return H`<button @click="${this.handleClick.bind(
            this
          )}"><div><wcm-wallet-image walletId="${this.walletId}" imageId="${tx(
            this.imageId
          )}"></wcm-wallet-image><wcm-text variant="xsmall-regular">${
            null != (e = this.label) ? e : t9.getWalletName(this.name, !0)
          }</wcm-text>${this.sublabelTemplate()}</div></button>`;
        }
      };
      (rL.styles = [tT.globalCss, rP]),
        rR([ep()], rL.prototype, "onClick", 2),
        rR([ep()], rL.prototype, "name", 2),
        rR([ep()], rL.prototype, "walletId", 2),
        rR([ep()], rL.prototype, "label", 2),
        rR([ep()], rL.prototype, "imageId", 2),
        rR([ep({ type: Boolean })], rL.prototype, "installed", 2),
        rR([ep({ type: Boolean })], rL.prototype, "recent", 2),
        (rL = rR([ed("wcm-wallet-button")], rL));
      let rW = c`:host{display:block}div{overflow:hidden;position:relative;border-radius:inherit;width:100%;height:100%;background-color:var(--wcm-color-overlay)}svg{position:relative;width:100%;height:100%}div::after{content:'';position:absolute;top:0;bottom:0;left:0;right:0;border-radius:inherit;border:1px solid var(--wcm-color-overlay)}div img{width:100%;height:100%;object-fit:cover;object-position:center}#wallet-placeholder-fill{fill:var(--wcm-color-bg-3)}#wallet-placeholder-dash{stroke:var(--wcm-color-overlay)}`;
      var rj = Object.defineProperty,
        rD = Object.getOwnPropertyDescriptor,
        rN = (e, t, r, i) => {
          for (
            var o, l = i > 1 ? void 0 : i ? rD(t, r) : t, a = e.length - 1;
            a >= 0;
            a--
          )
            (o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
          return i && l && rj(t, r, l), l;
        };
        ...
        render() {
          ...
          let t =
            null != (e = this.imageUrl) && e.length
              ? this.imageUrl
              : t9.getWalletIcon({ id: this.walletId, image_id: this.imageId });
          return H`${
            t.length
              ? H`<div><img crossorigin="anonymous" src="${t}" alt="${this.id}"></div>`
              : tV.WALLET_PLACEHOLDER
          }`;
        }
      };
      (rU.styles = [tT.globalCss, rW]),
        rN([ep()], rU.prototype, "walletId", 2),
        rN([ep()], rU.prototype, "imageId", 2),
        rN([ep()], rU.prototype, "imageUrl", 2),
        (rU = rN([ed("wcm-wallet-image")], rU));
      var rz = Object.defineProperty,
        rH = Object.getOwnPropertyDescriptor,
        rZ = (e, t, r, i) => {
          for (
            var o, l = i > 1 ? void 0 : i ? rH(t, r) : t, a = e.length - 1;
            a >= 0;
            a--
          )
            (o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
          return i && l && rz(t, r, l), l;
        };
      let rB = class extends es {
        constructor() {
        ...
        async loadImages(e) {
          try {
            null != e &&
              e.length &&
              (await Promise.all(e.map(async (e) => t9.preloadImage(e))));
          } catch {
      ...
      rZ([eu()], rB.prototype, "preload", 2),
        (rB = rZ([ed("wcm-explorer-context")], rB));
      var rV = Object.defineProperty,
        rq = Object.getOwnPropertyDescriptor;
      let rF = class extends es {
        constructor() {
          super(),
            (this.unsubscribeTheme = void 0),
            tT.setTheme(),
            (this.unsubscribeTheme = eC.ThemeCtrl.subscribe(tT.setTheme));
        }
        disconnectedCallback() {
          var e;
      ...
      (rG.styles = [tT.globalCss, rK]),
        (rG = ((e, t, r, i) => {
          for (
            var o, l = i > 1 ? void 0 : i ? rY(t, r) : t, a = e.length - 1;
            a >= 0;
            a--
          )
            (o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
          return i && l && rQ(t, r, l), l;
        })([ed("wcm-android-wallet-selection")], rG));
      let rX = c`@keyframes loading{to{stroke-dashoffset:0}}@keyframes shake{10%,90%{transform:translate3d(-1px,0,0)}20%,80%{transform:translate3d(1px,0,0)}30%,50%,70%{transform:translate3d(-2px,0,0)}40%,60%{transform:translate3d(2px,0,0)}}:host{display:flex;flex-direction:column;align-items:center}div{position:relative;width:110px;height:110px;display:flex;justify-content:center;align-items:center;margin:40px 0 20px 0;transform:translate3d(0,0,0)}svg{position:absolute;width:110px;height:110px;fill:none;stroke:transparent;stroke-linecap:round;stroke-width:2px;top:0;left:0}use{stroke:var(--wcm-accent-color);animation:loading 1s linear infinite}wcm-wallet-image{border-radius:var(--wcm-wallet-icon-large-border-radius);width:90px;height:90px}wcm-text{margin-bottom:40px}.wcm-error svg{stroke:var(--wcm-error-color)}.wcm-error use{display:none}.wcm-error{animation:shake .4s cubic-bezier(.36,.07,.19,.97) both}.wcm-stale svg,.wcm-stale use{display:none}`;
      var rJ = Object.defineProperty,
        r0 = Object.getOwnPropertyDescriptor,
        r1 = (e, t, r, i) => {
          for (
            var o, l = i > 1 ? void 0 : i ? r0(t, r) : t, a = e.length - 1;
            a >= 0;
            a--
          )
            (o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
      ...
      let r2 = class extends es {
        ...
        svgLoaderTemplate() {
          ...
          let r =
              ...
              (t =
                ...
                ? t
                : tT.getPreset("--wcm-wallet-icon-large-border-radius"),
            i = 0;
          i =
        ...
        render() {
          ...
          return H`<div class="${eg(
            e
          )}">${this.svgLoaderTemplate()}<wcm-wallet-image walletId="${tx(
            this.walletId
          )}" imageId="${tx(
            this.imageId
      ...
      (r2.styles = [tT.globalCss, rX]),
        r1([ep()], r2.prototype, "walletId", 2),
        r1([ep()], r2.prototype, "imageId", 2),
        r1([ep({ type: Boolean })], r2.prototype, "isError", 2),
        r1([ep({ type: Boolean })], r2.prototype, "isStale", 2),
        r1([ep()], r2.prototype, "label", 2),
        (r2 = r1([ed("wcm-connector-waiting")], r2));
      let r5 = {
          manualWallets() {
            var e, t;
            let { mobileWallets: r, desktopWallets: i } = eC.ConfigCtrl.state,
              o = null == (e = r5.recentWallet()) ? void 0 : e.id,
          ...
          recentWallet: () => t9.getRecentWallet(),
          recomendedWallets(e = !1) {
            var t;
            let r = e || null == (t = r5.recentWallet()) ? void 0 : t.id,
      ...
      (r8.styles = [tT.globalCss, r4]),
        (r8 = ((e, t, r, i) => {
          for (
            var o, l = i > 1 ? void 0 : i ? r6(t, r) : t, a = e.length - 1;
            a >= 0;
            a--
          )
            (o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
          return i && l && r7(t, r, l), l;
        })([ed("wcm-desktop-wallet-selection")], r8));
      ...
      (ir.styles = [tT.globalCss, r9]),
        (ir = ((e, t, r, i) => {
          for (
            var o, l = i > 1 ? void 0 : i ? it(t, r) : t, a = e.length - 1;
            a >= 0;
            a--
          )
            (o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
          return i && l && ie(t, r, l), l;
        })([ed("wcm-legal-notice")], ir));
      let ii = c`div{display:grid;grid-template-columns:repeat(4,80px);margin:0 -10px;justify-content:space-between;row-gap:10px}`;
      var io = Object.defineProperty,
        il = Object.getOwnPropertyDescriptor;
      let ia = class extends es {
        onQrcode() {
          eC.AV.push("Qrcode");
        }
        render() {
          ...
          return H`<wcm-modal-header title="Connect your wallet" .onAction="${
            this.onQrcode
          }" .actionIcon="${tV.QRCODE_ICON}"></wcm-modal-header>${
            n
      ...
      (ia.styles = [tT.globalCss, ii]),
        (ia = ((e, t, r, i) => {
          for (
            var o, l = i > 1 ? void 0 : i ? il(t, r) : t, a = e.length - 1;
            a >= 0;
            a--
          )
            (o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
          return i && l && io(t, r, l), l;
        })([ed("wcm-mobile-wallet-selection")], ia));
      let is = c`:host{all:initial}.wcm-overlay{top:0;bottom:0;left:0;right:0;position:fixed;z-index:var(--wcm-z-index);overflow:hidden;display:flex;justify-content:center;align-items:center;opacity:0;pointer-events:none;background-color:var(--wcm-overlay-background-color);backdrop-filter:var(--wcm-overlay-backdrop-filter)}@media(max-height:720px) and (orientation:landscape){.wcm-overlay{overflow:scroll;align-items:flex-start;padding:20px 0}}.wcm-active{pointer-events:auto}.wcm-container{position:relative;max-width:360px;width:100%;outline:0;border-radius:var(--wcm-background-border-radius) var(--wcm-background-border-radius) var(--wcm-container-border-radius) var(--wcm-container-border-radius);border:1px solid var(--wcm-color-overlay);overflow:hidden}.wcm-card{width:100%;position:relative;border-radius:var(--wcm-container-border-radius);overflow:hidden;box-shadow:0 6px 14px -6px rgba(10,16,31,.12),0 10px 32px -4px rgba(10,16,31,.1),0 0 0 1px var(--wcm-color-overlay);background-color:var(--wcm-color-bg-1);color:var(--wcm-color-fg-1)}@media(max-width:600px){.wcm-container{max-width:440px;border-radius:var(--wcm-background-border-radius) var(--wcm-background-border-radius) 0 0}.wcm-card{border-radius:var(--wcm-container-border-radius) var(--wcm-container-border-radius) 0 0}.wcm-overlay{align-items:flex-end}}@media(max-width:440px){.wcm-container{border:0}}`;
      var ic = Object.defineProperty,
        id = Object.getOwnPropertyDescriptor,
        ih = (e, t, r, i) => {
          for (
            var o, l = i > 1 ? void 0 : i ? id(t, r) : t, a = e.length - 1;
            a >= 0;
            a--
          )
            (o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
      ...
      let im = class extends es {
        ...
        get overlayEl() {
          return t9.getShadowRootElement(this, ".wcm-overlay");
        }
        get containerEl() {
          return t9.getShadowRootElement(this, ".wcm-container");
        }
        toggleBodyScroll(e) {
          ...
          this.toggleBodyScroll(!1),
            ...
            setTimeout(async () => {
              ...
              await Promise.all([
                ...
                ty(this.containerEl, e, { delay: 0.1, duration: 0.2 }).finished,
              ]),
                (this.active = !0);
            }, 0);
        }
        async onCloseModalEvent() {
          ...
          let e = t9.isMobileAnimation()
            ...
            : { scale: [1, 0.98] };
          await Promise.all([
            ty(this.overlayEl, { opacity: [1, 0] }, { duration: 0.2 }).finished,
            ty(this.containerEl, e, { duration: 0.2 }).finished,
          ]),
      ...
      (im.styles = [tT.globalCss, is]),
        ih([eu()], im.prototype, "open", 2),
        ih([eu()], im.prototype, "active", 2),
        (im = ih([ed("wcm-modal")], im));
      let ip = c`div{display:flex;margin-top:15px}slot{display:inline-block;margin:0 5px}wcm-button{margin:0 5px}`;
      var iu = Object.defineProperty,
        iw = Object.getOwnPropertyDescriptor,
        ig = (e, t, r, i) => {
          for (
            var o, l = i > 1 ? void 0 : i ? iw(t, r) : t, a = e.length - 1;
            a >= 0;
            a--
          )
            (o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
      ...
      let iv = class extends es {
        ...
        render() {
          return H`<div>${this.isRetry ? H`<slot></slot>` : null} ${
            this.isMobile
              ? H`<wcm-button .onClick="${this.onMobile}" .iconLeft="${tV.MOBILE_ICON}" variant="outline">Mobile</wcm-button>`
              : null
          } ${
            this.isDesktop
              ? H`<wcm-button .onClick="${this.onDesktop}" .iconLeft="${tV.DESKTOP_ICON}" variant="outline">Desktop</wcm-button>`
              : null
          } ${
            this.isWeb
              ? H`<wcm-button .onClick="${this.onWeb}" .iconLeft="${tV.GLOBE_ICON}" variant="outline">Web</wcm-button>`
              : null
          }</div>`;
        }
      };
      (iv.styles = [tT.globalCss, ip]),
        ig([ep({ type: Boolean })], iv.prototype, "isMobile", 2),
        ig([ep({ type: Boolean })], iv.prototype, "isDesktop", 2),
        ig([ep({ type: Boolean })], iv.prototype, "isWeb", 2),
        ig([ep({ type: Boolean })], iv.prototype, "isRetry", 2),
        (iv = ig([ed("wcm-platform-selection")], iv));
      let ib = c`button{display:flex;flex-direction:column;padding:5px 10px;border-radius:var(--wcm-button-hover-highlight-border-radius);height:100%;justify-content:flex-start}.wcm-icons{width:60px;height:60px;display:flex;flex-wrap:wrap;padding:7px;border-radius:var(--wcm-wallet-icon-border-radius);justify-content:space-between;align-items:center;margin-bottom:5px;background-color:var(--wcm-color-bg-2);box-shadow:inset 0 0 0 1px var(--wcm-color-overlay)}button:active{background-color:var(--wcm-color-overlay)}@media(hover:hover){button:hover{background-color:var(--wcm-color-overlay)}}.wcm-icons img{width:21px;height:21px;object-fit:cover;object-position:center;border-radius:calc(var(--wcm-wallet-icon-border-radius)/ 2);border:1px solid var(--wcm-color-overlay)}.wcm-icons svg{width:21px;height:21px}.wcm-icons img:nth-child(1),.wcm-icons img:nth-child(2),.wcm-icons svg:nth-child(1),.wcm-icons svg:nth-child(2){margin-bottom:4px}wcm-text{width:100%;text-align:center}#wallet-placeholder-fill{fill:var(--wcm-color-bg-3)}#wallet-placeholder-dash{stroke:var(--wcm-color-overlay)}`;
      var iy = Object.defineProperty,
        ix = Object.getOwnPropertyDescriptor;
      let i$ = class extends es {
        onClick() {
        ...
        render() {
          ...
          return H`<button @click="${
            this.onClick
          }"><div class="wcm-icons">${r.map((e) => {
            let t = t9.getWalletIcon(e);
            if (t) return H`<img crossorigin="anonymous" src="${t}">`;
            let r = t9.getWalletIcon({ id: e.id });
            return r
      ...
      (i$.styles = [tT.globalCss, ib]),
        (i$ = ((e, t, r, i) => {
          for (
            var o, l = i > 1 ? void 0 : i ? ix(t, r) : t, a = e.length - 1;
            a >= 0;
            a--
          )
            (o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
          return i && l && iy(t, r, l), l;
        })([ed("wcm-view-all-wallets-button")], i$));
      let iC = c`.wcm-qr-container{width:100%;display:flex;justify-content:center;align-items:center;aspect-ratio:1/1}`;
      var iA = Object.defineProperty,
        i_ = Object.getOwnPropertyDescriptor,
        iO = (e, t, r, i) => {
          for (
            var o, l = i > 1 ? void 0 : i ? i_(t, r) : t, a = e.length - 1;
            a >= 0;
            a--
          )
            (o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
          return i && l && iA(t, r, l), l;
        };
      let iE = class extends es {
        ...
        get overlayEl() {
          return t9.getShadowRootElement(this, ".wcm-qr-container");
        }
        render() {
          return H`<div class="wcm-qr-container">${
            this.uri
              ? H`<wcm-qrcode size="${this.overlayEl.offsetWidth}" uri="${
                  this.uri
                }" walletId="${tx(this.walletId)}" imageId="${tx(
                  this.imageId
                )}"></wcm-qrcode>`
      ...
      (iE.styles = [tT.globalCss, iC]),
        iO([ep()], iE.prototype, "walletId", 2),
        iO([ep()], iE.prototype, "imageId", 2),
        iO([eu()], iE.prototype, "uri", 2),
        (iE = iO([ed("wcm-walletconnect-qr")], iE));
      ...
      (iT.styles = [tT.globalCss]),
        (iT = ((e, t, r, i) => {
          for (
            var o, l = i > 1 ? void 0 : i ? iI(t, r) : t, a = e.length - 1;
            a >= 0;
            a--
          )
            (o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
          return i && l && ik(t, r, l), l;
        })([ed("wcm-connect-wallet-view")], iT));
      let iP = c`wcm-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}wcm-text{text-align:center}`;
      var iM = Object.defineProperty,
        iS = Object.getOwnPropertyDescriptor,
        iR = (e, t, r, i) => {
          for (
            var o, l = i > 1 ? void 0 : i ? iS(t, r) : t, a = e.length - 1;
            a >= 0;
            a--
          )
            (o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
          return i && l && iM(t, r, l), l;
        };
      let iL = class extends es {
        ...
        openDesktopApp() {
          ...
          t9.setRecentWallet(t), e && this.onFormatAndRedirect(e);
        }
        render() {
          let { name: e, id: t, image_id: r } = eC.zv.getWalletRouterData(),
            { isMobile: i, isWeb: o } = t9.getCachedRouterWalletPlatforms();
          return H`<wcm-modal-header title="${e}" .onAction="${
            t9.handleUriCopy
          }" .actionIcon="${
            tV.COPY_ICON
          }"></wcm-modal-header><wcm-modal-content><wcm-connector-waiting walletId="${t}" imageId="${tx(
            r
      ...
      (iL.styles = [tT.globalCss, iP]),
        iR([eu()], iL.prototype, "isError", 2),
        (iL = iR([ed("wcm-desktop-connecting-view")], iL));
      let iW = c`wcm-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}wcm-text{text-align:center}wcm-button{margin-top:15px}`;
      var ij = Object.defineProperty,
        iD = Object.getOwnPropertyDescriptor;
      let iN = class extends es {
        onInstall(e) {
        ...
        render() {
          ...
          return H`<wcm-modal-header title="${e}"></wcm-modal-header><wcm-modal-content><wcm-connector-waiting walletId="${t}" imageId="${tx(
            r
      ...
      (iN.styles = [tT.globalCss, iW]),
        (iN = ((e, t, r, i) => {
          for (
            ...
            (o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
          return i && l && ij(t, r, l), l;
        })([ed("wcm-install-wallet-view")], iN));
      ...
      var iz = Object.defineProperty,
        ...
        iZ = (e, t, r, i) => {
          for (
            var o, l = i > 1 ? void 0 : i ? iH(t, r) : t, a = e.length - 1;
            a >= 0;
            a--
          )
            (o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
          return i && l && iz(t, r, l), l;
        };
      let iB = class extends es {
        ...
        openMobileApp(e = !1) {
          ...
          t9.setRecentWallet(r), t && this.onFormatAndRedirect(t, e);
        }
        onGoToAppStore(e) {
          e && eC.zv.openHref(e, "_blank");
        }
        render() {
          let {
            ...
            { isWeb: l } = t9.getCachedRouterWalletPlatforms(),
            a = i?.ios,
            n = o?.universal;
          return H`<wcm-modal-header title="${e}"></wcm-modal-header><wcm-modal-content><wcm-connector-waiting walletId="${t}" imageId="${tx(
            r
            ...
            n
              ...
              : null
          }</wcm-info-footer><wcm-info-footer class="wcm-app-store"><div><wcm-wallet-image walletId="${t}" imageId="${tx(
            r
      ...
      (iB.styles = [tT.globalCss, iU]),
        iZ([eu()], iB.prototype, "isError", 2),
        (iB = iZ([ed("wcm-mobile-connecting-view")], iB));
      let iV = c`wcm-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}wcm-text{text-align:center}`;
      var iq = Object.defineProperty,
        iF = Object.getOwnPropertyDescriptor;
      let iK = class extends es {
        render() {
          let { name: e, id: t, image_id: r } = eC.zv.getWalletRouterData(),
            { isDesktop: i, isWeb: o } = t9.getCachedRouterWalletPlatforms();
          return H`<wcm-modal-header title="${e}" .onAction="${
            t9.handleUriCopy
          }" .actionIcon="${
            tV.COPY_ICON
          }"></wcm-modal-header><wcm-modal-content><wcm-walletconnect-qr walletId="${t}" imageId="${tx(
            r
      ...
      (iK.styles = [tT.globalCss, iV]),
        (iK = ((e, t, r, i) => {
          for (
            var o, l = i > 1 ? void 0 : i ? iF(t, r) : t, a = e.length - 1;
            a >= 0;
            a--
          )
            (o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
          return i && l && iq(t, r, l), l;
        })([ed("wcm-mobile-qr-connecting-view")], iK));
      var iQ = Object.defineProperty,
        iY = Object.getOwnPropertyDescriptor;
      let iG = class extends es {
        render() {
          return H`<wcm-modal-header title="Scan the code" .onAction="${t9.handleUriCopy}" .actionIcon="${tV.COPY_ICON}"></wcm-modal-header><wcm-modal-content><wcm-walletconnect-qr></wcm-walletconnect-qr></wcm-modal-content>`;
        }
      };
      (iG.styles = [tT.globalCss]),
        (iG = ((e, t, r, i) => {
          for (
            ...
            (o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
          return i && l && iQ(t, r, l), l;
        })([ed("wcm-qrcode-view")], iG));
      let iX = c`wcm-modal-content{height:clamp(200px,60vh,600px);display:block;overflow:scroll;scrollbar-width:none;position:relative;margin-top:1px}.wcm-grid{display:grid;grid-template-columns:repeat(4,80px);justify-content:space-between;margin:-15px -10px;padding-top:20px}wcm-modal-content::after,wcm-modal-content::before{content:'';position:fixed;pointer-events:none;z-index:1;width:100%;height:20px;opacity:1}wcm-modal-content::before{box-shadow:0 -1px 0 0 var(--wcm-color-bg-1);background:linear-gradient(var(--wcm-color-bg-1),rgba(255,255,255,0))}wcm-modal-content::after{box-shadow:0 1px 0 0 var(--wcm-color-bg-1);background:linear-gradient(rgba(255,255,255,0),var(--wcm-color-bg-1));top:calc(100% - 20px)}wcm-modal-content::-webkit-scrollbar{display:none}.wcm-placeholder-block{display:flex;justify-content:center;align-items:center;height:100px;overflow:hidden}.wcm-empty,.wcm-loading{display:flex}.wcm-loading .wcm-placeholder-block{height:100%}.wcm-end-reached .wcm-placeholder-block{height:0;opacity:0}.wcm-empty .wcm-placeholder-block{opacity:1;height:100%}wcm-wallet-button{margin:calc((100% - 60px)/ 3) 0}`;
      var iJ = Object.defineProperty,
        i0 = Object.getOwnPropertyDescriptor,
        i1 = (e, t, r, i) => {
          for (
            var o, l = i > 1 ? void 0 : i ? i0(t, r) : t, a = e.length - 1;
            a >= 0;
            a--
          )
            (o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
      ...
      let i2 = class extends es {
        constructor() {
          super(...arguments),
            ...
            (this.searchDebounce = t9.debounce((e) => {
              e.length >= 1
                ? ((this.firstFetch = !0),
                  (this.endReached = !1),
                  (this.search = e),
        ...
        get placeholderEl() {
          return t9.getShadowRootElement(this, ".wcm-placeholder-block");
        }
          ...
          if (!this.endReached && (this.firstFetch || (o > 40 && i.length < o)))
            try {
              ...
              let t =
                ...
                i = r.map((e) => t9.getWalletIcon(e));
              await Promise.all([
                ...i.map(async (e) => t9.preloadImage(e)),
                eC.zv.wait(300),
              ]),
                (this.endReached = this.isLastPage());
            } catch (e) {
              console.error(e),
                eC.ToastCtrl.openToast(t9.getErrorMessage(e), "error");
            } finally {
        ...
        render() {
          let { wallets: e, search: t } = eC.ExplorerCtrl.state,
            ...
            l = r3.manualWalletsTemplate(),
            a = r3.recomendedWalletsTemplate(!0);
          o &&
            ((l = l.filter(({ values: e }) =>
              t9.caseSafeIncludes(e[0], this.search)
            )),
            (a = a.filter(({ values: e }) =>
              t9.caseSafeIncludes(e[0], this.search)
            )));
      ...
      (i2.styles = [tT.globalCss, iX]),
        i1([eu()], i2.prototype, "loading", 2),
        i1([eu()], i2.prototype, "firstFetch", 2),
        i1([eu()], i2.prototype, "search", 2),
        i1([eu()], i2.prototype, "endReached", 2),
        (i2 = i1([ed("wcm-wallet-explorer-view")], i2));
      let i5 = c`wcm-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}wcm-text{text-align:center}`;
      var i3 = Object.defineProperty,
        i4 = Object.getOwnPropertyDescriptor,
        i7 = (e, t, r, i) => {
          for (
            var o, l = i > 1 ? void 0 : i ? i4(t, r) : t, a = e.length - 1;
            a >= 0;
            a--
          )
            (o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
      ...
      let i6 = class extends es {
        ...
        render() {
          let { name: e, id: t, image_id: r } = eC.zv.getWalletRouterData(),
            { isMobile: i, isDesktop: o } = t9.getCachedRouterWalletPlatforms(),
            l = eC.zv.isMobile();
          return H`<wcm-modal-header title="${e}" .onAction="${
            t9.handleUriCopy
          }" .actionIcon="${
      ...
      (i6.styles = [tT.globalCss, i5]),
        i7([eu()], i6.prototype, "isError", 2),
        (i6 = i7([ed("wcm-web-connecting-view")], i6));
    },
  },
]);
